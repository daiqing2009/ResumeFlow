...
from zlm.prompts.sections_prompt import EXPERIENCE
...
ds_file_path = "eval_json_exp_ds.json"
ds_file_path2 = "eval_json_exp_ds2.json"
ds_file_path3 = "eval_json_exp_ds3.json"
json_data, inf_res = [],[]
try:
...
try:
    with open(ds_file_path3, "r", encoding="utf-8") as j_file3:  # Specify UTF-8 encoding
        data3 = json.load(j_file3)
        json_data += data3
except FileNotFoundError:
    print("File not found.")
except Exception as e:
...
inference_llm = AutoApplyModel(api_key="", provider="Ollama", model = model_name, downloads_dir="C:/Users/Wilfried/Downloads/") # replace with your local dir
...
inference_output_ds = "finetuned_gemma2_exp_ds.json"
try:
